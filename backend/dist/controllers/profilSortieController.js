...
const ProfilSortiService_js_1 = require("../services/ProfilSortiService.js");
const profilSortiValidator_js_1 = require("../validators/profilSortiValidator.js");
const profilSortiService = ProfilSortiService_js_1.ProfilSortiService.getInstance();
const createProfilsSortie = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const data = profilSortiValidator_js_1.profilSortieSchema.parse(req.body);
        console.log(data);
